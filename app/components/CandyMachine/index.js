...
const CandyMachine = ({ walletAddress }) => {
    // Add state property inside your component
    // state variable holds candy machine stats
    ...
    // getProvider creates a new AnchorProvider object
    // The provider is how our web app talks to the Solana blockchain
    // It gives our client a connection to Solana + our wallet credentials so we can talk to programs on Solana
    const getProvider = () => {
    ...
    const getCandyMachineState = async () => {
        ...
        // We created a state variable above and then make a call to setCandyMachine to set the data
        setCandyMachine({
    ...
    const mintToken = async () => {
        // All the params candy machine needs to mint the NFT, including userPayingAccountAddress and mint
        // Account address of the NFT we'll be minting
        const mint = web3.Keypair.generate();
        // Here we are creating an account for our NFT
        const userTokenAccountAddress = (
            await getAtaForMint(mint.publicKey, walletAddress.publicKey)
        )[0];
        // Person paying + receiving the NFT
        ...
        // Here, we bundle a few instructions which are basically functions that live on our candy machine
        // Metaplex gave us these functions, we just hit them
        const instructions = [
        ...
        // Here we are checking if the Candy machine is using a captcha to prevent bots with gatekeeper,
        ...
        // After all the checks have passed, we create the instructions for actually minting the NFT
        ...
        // We use a provider, our wallet, all our instructions, 
        // and then call sendTransactions which is a function that talks to the blockchain
        // This is the magic line where we actually hit our candy machine and tell it mint our NFT
        try {
            return (
    ...
    return (
        // Only show this is machineStats is available
